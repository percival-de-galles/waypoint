...
When you change a new thread's project, Waypoint stays in the current environment
...
If dragging is unavailable for one environment, update the Waypoint server running in that
