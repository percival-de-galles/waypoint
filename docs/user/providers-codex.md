...
Both instances must use the same **CODEX_HOME path**. Waypoint prepares the shared
...
Choose the other account from the thread's model picker. Waypoint offers compatible
