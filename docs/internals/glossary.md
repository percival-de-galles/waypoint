...
Terms whose meaning matters across Waypoint. Architecture and lifecycle constraints belong in the
...
| Waypoint home        | The base data directory. Runtime state normally lives under its `userdata` directory.             |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Waypoint controls, such as Codex or Claude Code.                                            |
...
| Adapter             | The boundary translating a provider's native protocol into Waypoint operations and events.                    |
