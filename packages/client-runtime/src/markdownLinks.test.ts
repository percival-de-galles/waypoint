...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    [
      "file:///D:/Programme/waypoint/OpenInPicker.tsx#L69",
      "D:/Programme/waypoint/OpenInPicker.tsx",
      "#L69",
    ],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/waypoint/OpenInPicker.tsx", "D:/Programme/waypoint/OpenInPicker.tsx"],
    ["</D:/Programme/waypoint/ChatMarkdown.tsx:1>", "D:/Programme/waypoint/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\waypoint\\apps\\web\\a.ts", "C:/Users/mike/waypoint", "apps/web/a.ts"],
    ["/C:/Users/mike/waypoint/apps/web/a.ts", "C:/Users/mike/waypoint", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/waypoint/main.ts", "c:/users/MIKE/waypoint", "main.ts"],
    ["/C:/USERS/mike/waypoint/main.ts", "/c:/users/MIKE/waypoint", "main.ts"],
