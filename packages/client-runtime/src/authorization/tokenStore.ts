...
import { RelayManagedEndpoint } from "@waypoint/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@waypoint/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@waypoint/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
