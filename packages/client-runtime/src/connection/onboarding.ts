import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@waypoint/contracts";
import { resolveRemotePairingTarget } from "@waypoint/shared/remote";
...
>()("@waypoint/client-runtime/connection/onboarding/ConnectionOnboarding") {}
