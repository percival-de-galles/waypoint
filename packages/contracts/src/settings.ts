...
/**
 * The environment's theme, set with `waypoint theme set <id>`. Each client applies
...
// Deliberately absent from ServerSettingsPatch: `waypoint theme set` checks that an
...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    shadowHomePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "~/.codex-waypoint/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Waypoint spawn the server when needed.",
        providerSettingsForm: {
...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    agentDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description:
          "Custom Pi configuration and credential directory. Leave blank to use Pi's ~/.pi/agent directory.",
        providerSettingsForm: {
...
export const ServerSettings = Schema.Struct({
   ...
   * withholds the MCP credential, so the `waypoint` server (and with it every
  ...
  /**
   * Whether this server may install and run Waypoint's device helper processes.
   ...
   * of the same value from one they already applied: `waypoint theme set` must act
