 ...
 * machine into a Waypoint browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Waypoint profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Waypoint Full Disk Access in System Settings → Privacy & Security, then retry.",
