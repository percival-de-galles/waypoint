...
import { WaypointProjectFile } from "./waypointProjectFile.ts";

const decode = Schema.decodeUnknownSync(WaypointProjectFile);

describe("WaypointProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://waypoint.invalid/schema/waypoint.json",
