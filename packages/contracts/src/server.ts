...
/**
 * A palette the environment's machine publishes for Waypoint to follow, read
 ...
 * over as a coherent Waypoint palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `waypoint` package to install (never a dist-tag, so
