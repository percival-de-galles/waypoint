...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set WAYPOINT_BITBUCKET_EMAIL and WAYPOINT_BITBUCKET_API_TOKEN, or WAYPOINT_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check WAYPOINT_BITBUCKET_EMAIL and WAYPOINT_BITBUCKET_API_TOKEN.",
  },
};
