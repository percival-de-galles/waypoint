export const BUILT_IN_THEME_IDS = ["waypoint-chat", "grove", "ocean", "ember", "iris"] as const;

/** The mobile app's own hand-tuned palette, which is not part of the built-in library. */
export const MOBILE_DEFAULT_THEME_ID = "waypoint";
...
export const WAYPOINT_CHAT_THEME: ThemeDefinition = {
  id: "waypoint-chat",
  label: "Waypoint Chat",
  appearance: "light",
  colors: {
