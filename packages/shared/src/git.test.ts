import type { VcsStatusRemoteResult, VcsStatusResult } from "@waypoint/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:WaypointTools/Waypoint.git")).toBe(
      "github.com/waypointtools/waypoint",
    );
    expect(normalizeGitRemoteUrl("https://github.com/WaypointTools/Waypoint.git")).toBe(
      "github.com/waypointtools/waypoint",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/WaypointTools/Waypoint")).toBe(
      "github.com/waypointtools/waypoint",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:WaypointTools/platform/Waypoint.git")).toBe(
      "gitlab.com/waypointtools/platform/waypoint",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/WaypointTools/platform/Waypoint.git")).toBe(
      "gitlab.com/waypointtools/platform/waypoint",
    );
  });
...
describe("parseOriginUrlFromGitConfig", () => {
  it("reads the origin url and ignores other remotes", () => {
    ...
    expect(parseOriginUrlFromGitConfig(config)).toBe("git@github.com:pingdotgg/waypoint.git");
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:WaypointTools/Waypoint.git"),
    ).toBe("WaypointTools/Waypoint");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/WaypointTools/Waypoint.git"),
    ).toBe("WaypointTools/Waypoint");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("ssh://github.com/WaypointTools/Waypoint.git"),
    ).toBe("WaypointTools/Waypoint");
  });
});
