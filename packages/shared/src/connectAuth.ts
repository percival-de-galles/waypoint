 ...
 * default lives here.
 */
// `.invalid` is reserved by RFC 2606. Cloud linking stays deliberately inert
// until a Waypoint deployment is configured with WAYPOINT_HOSTED_APP_URL.
export const DEFAULT_HOSTED_APP_URL = "https://waypoint.invalid";
...
export function checkConnectAuthCode(
  ...
  if (parsed === null) {
    return "That does not look like a Waypoint Connect code. Copy the full code.";
  }
