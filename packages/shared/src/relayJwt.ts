...
export const RELAY_LINK_PROOF_TYP = "waypoint-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "waypoint-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "waypoint-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "waypoint-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "waypoint-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "waypoint-env-activity+jwt";
