  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Waypoint prerelease is available for nightly testers."
          : "A new Waypoint latest release is available.",
...
).pipe(Command.withDescription("Post a Waypoint release announcement to Discord."));
