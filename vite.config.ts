...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-waypoint/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    rules: {
      ...
      "eslint/no-restricted-imports": [
        "error",
        {
          paths: [
            {
              name: "@waypoint/client-runtime",
              message:
                "Import from an explicit @waypoint/client-runtime/* subpath. The package has no root export.",
            },
            {
      ...
      "waypoint/no-global-process-runtime": "error",
      "waypoint/no-inline-schema-compile": "warn",
      "waypoint/no-manual-effect-runtime-in-tests": "error",
      "waypoint/no-native-title-tooltip": "error",
      "waypoint/namespace-node-imports": "error",
    },
    overrides: [
      {
        // The one place that reads the host platform to seed the injected references.
        files: ["packages/shared/src/hostProcess.ts"],
        rules: { "waypoint/no-global-process-runtime": "off" },
      },
      {
        files: ["apps/mobile/src/**"],
        rules: { "waypoint/no-mobile-uniwind-theme-escape-hatches": "error" },
      },
      {
        ...
        files: [
          ...
          "apps/mobile/src/native/WaypointComposerEditor.ios.tsx",
          "apps/mobile/src/native/WaypointComposerEditor.native.tsx",
        ],
        rules: {
          "waypoint/no-mobile-uniwind-theme-escape-hatches": ["error", { allowUniwindTheme: true }],
        },
      },
      ...
      ...Object.entries({
        ...
        return { files: [file], rules: { "waypoint/no-manual-effect-runtime-in-tests": rule } };
      }),
    ],
    options: {
