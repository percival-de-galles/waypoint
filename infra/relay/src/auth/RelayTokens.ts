...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@waypoint/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "waypoint-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "waypoint-relay-dpop-access+jwt";
...
>()("waypoint-relay/auth/RelayTokens") {}
