...
Item {
    ...
    // A cached, bounded PNG is shared by each output. Nothing repaints while waiting for Waypoint.
    Image {
        id: snapshot
        visible: false
    ...
    DBusCall {
        id: next
        service: root.bus
        path: "/com/waypointtools/KdeCapture/Feedback"
        dbusInterface: "dev.waypoint.KdeCapture.Feedback"
        method: "Next"
