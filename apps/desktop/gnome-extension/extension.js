...
const NAME = "org.gnome.Shell.Extensions.WaypointSnapShot";
const PATH = "/org/gnome/Shell/Extensions/WaypointSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`Waypoint capture preview unavailable: ${error.message}`);
    }
  }
...
export default class WaypointSnapShotExtension extends Extension {
  enable() {
