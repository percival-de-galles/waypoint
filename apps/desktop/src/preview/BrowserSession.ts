...
const PREVIEW_PARTITION_PREFIX = "persist:waypoint-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "waypoint-preview-ephemeral-";
...
>()("@waypoint/desktop/preview/BrowserSession") {}
