...
const EXTENSION = "org.gnome.Shell.Extensions.WaypointSnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/WaypointSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Waypoint instance is capturing a window. Try again.");
    }
