import { createAdvertisedEndpoint } from "@waypoint/shared/advertisedEndpoint";
import type { AdvertisedEndpoint, AdvertisedEndpointProvider } from "@waypoint/contracts";
import {
...
export { parseTailscaleMagicDnsName } from "@waypoint/tailscale";
