...
import { waitForHttpReady as waitForHttpReadyShared } from "@waypoint/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/waypoint/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // WAYPOINT_HOME can't pin the WSL backend to /mnt/c/...\.waypoint.
