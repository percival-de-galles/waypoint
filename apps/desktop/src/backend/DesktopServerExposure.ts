...
} from "@waypoint/shared/advertisedEndpoint";
import {
...
import { isTailscaleIpv4Address, readTailscaleStatus } from "@waypoint/tailscale";
...
>()("@waypoint/desktop/backend/DesktopServerExposure") {}
