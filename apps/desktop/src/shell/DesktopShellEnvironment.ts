...
>()("@waypoint/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__WAYPOINT_ENV_${name}_START__`;
const endMarker = (name: string) => `__WAYPOINT_ENV_${name}_END__`;
