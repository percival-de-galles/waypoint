...
import type { PersistedSavedEnvironmentRecord } from "@waypoint/contracts";
import { fromLenientJson } from "@waypoint/shared/schemaJson";
...
>()("@waypoint/desktop/app/DesktopConnectionCatalogStore") {}
