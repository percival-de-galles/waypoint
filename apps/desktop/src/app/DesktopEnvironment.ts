...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemoteWaypointServerEntryPath: Option.Option<string>;
...
>()("@waypoint/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Waypoint";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = resolveDesktopBaseDir({
    homeDirectory,
    joinPath: path.join,
    waypointHome: config.waypointHome,
  });
  ...
  const userDataDirName = isDevelopment ? "waypoint-dev" : "waypoint";
  const legacyUserDataDirName = isDevelopment ? "Waypoint (Dev)" : "Waypoint (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteWaypointServerEntryPath: config.devRemoteWaypointServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "dev.waypoint.app.dev" : "dev.waypoint.app",
    ),
    linuxDesktopEntryName: resolveLinuxDesktopEntryName(isDevelopment),
    linuxWmClass: isDevelopment ? "waypoint-dev" : "waypoint",
