import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@waypoint/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@waypoint/shared/observability";
...
>()("@waypoint/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
