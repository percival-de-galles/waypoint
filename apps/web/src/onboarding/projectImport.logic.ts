import { findProjectByPath } from "@waypoint/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@waypoint/contracts";
