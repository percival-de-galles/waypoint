...
import { resolveDefaultThreadEnvMode } from "@waypoint/shared/threadEnvMode";
...
import { readWaypointProjectFileDefaultThreadEnvMode } from "../lib/waypointProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The waypoint.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readWaypointProjectFileDefaultThreadEnvMode(
