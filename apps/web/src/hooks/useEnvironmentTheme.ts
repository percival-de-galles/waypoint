import type { EnvironmentTheme } from "@waypoint/contracts";
...
function publishedThemeColors(
  ...
  // desktop theme arrives as a coherent Waypoint palette rather than a foreign
 ...
 * than rendered: a published `waypoint-iris.json` would show this palette on its
