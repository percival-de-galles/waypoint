import { ProjectId, ThreadId } from "@waypoint/contracts";
...
describe("uiStateStore pure functions", () => {
  ...
  it("stores the sidebar project scope and resets it to all projects", () => {
    const scoped = setSidebarProjectScopeKey(makeUiState(), "github.com/pingdotgg/waypoint");

    expect(scoped.sidebarProjectScopeKey).toBe("github.com/pingdotgg/waypoint");
    expect(setSidebarProjectScopeKey(scoped, "github.com/pingdotgg/waypoint")).toBe(scoped);
...
describe("uiStateStore persistence", () => {
  ...
  it("restores the sidebar project scope across reloads", () => {
    persistState(makeUiState({ sidebarProjectScopeKey: "github.com/pingdotgg/waypoint" }));
