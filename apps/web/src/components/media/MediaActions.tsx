import type { MediaActionId } from "@waypoint/client-runtime/media-actions";
import {
  mediaReferenceFileName,
  type MediaReference,
} from "@waypoint/client-runtime/media-reference";
...
import type { AssetResource, ContextMenuItem, EnvironmentId } from "@waypoint/contracts";
