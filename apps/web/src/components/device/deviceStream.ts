 ...
 * through the Waypoint proxy. One class handles both platforms because the hub
 ...
 */
import type { DeviceHubAccess } from "@waypoint/client-runtime/state/deviceHubAccess";
import { withDeviceHubQuery } from "@waypoint/client-runtime/state/deviceHubAccess";
import type { DevicePlatform } from "@waypoint/contracts";
