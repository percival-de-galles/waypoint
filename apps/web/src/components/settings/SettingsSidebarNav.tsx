...
const WaypointConnectSidebarSignIn = lazy(() =>
  import("../clerk/WaypointConnectSidebarSignIn").then((module) => ({
    default: module.WaypointConnectSidebarSignIn,
  })),
);
const WaypointConnectSidebarAvatar = lazy(() =>
  import("../clerk/WaypointConnectSidebarSignIn").then((module) => ({
    default: module.WaypointConnectSidebarAvatar,
  })),
);
