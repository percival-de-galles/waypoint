import type { BrowserImportSource } from "@waypoint/contracts";
import { BROWSER_IMPORT_FAILURE_COPY } from "@waypoint/contracts";
...
function FullDiskAccessStep({
  ...
  return (
    <>
      <DialogHeader>
        <DialogTitle>Let Waypoint read {source.name}&rsquo;s cookies</DialogTitle>
        <DialogDescription>
          To import cookies from {source.name}, Waypoint needs Full Disk Access. Turn it on in System
      ...
      {stillRequired ? (
        <DialogPanel>
          <p role="status" className="text-sm text-muted-foreground">
            Full Disk Access is still required. If you just turned it on, quit and reopen Waypoint,
            then try again.
          </p>
        </DialogPanel>
      ) : null}
