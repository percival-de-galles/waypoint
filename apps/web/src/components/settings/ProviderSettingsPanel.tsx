...
import { connectionStatusTitle } from "@waypoint/client-runtime/connection";
import { safeErrorLogAttributes } from "@waypoint/client-runtime/errors";
import {
...
import { DEFAULT_UNIFIED_SETTINGS } from "@waypoint/contracts/settings";
import {
  getBackgroundActivityPresetSettings,
  resolveServerBackgroundActivitySettings,
} from "@waypoint/shared/backgroundActivitySettings";
...
function providerEnvironmentDetail(environment: EnvironmentPresentation): string {
  ...
  if (environment.relayManaged) return "Waypoint Connect";
