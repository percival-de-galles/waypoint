...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@waypoint/contracts";
...
/**
 * Post-sign-in onboarding wizard for Waypoint Connect. Opens on every in-session
 ...
 * account's Waypoint Connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "Waypoint Connect enabled",
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Waypoint Connect."
