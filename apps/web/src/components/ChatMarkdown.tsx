...
import { inlineCodeFilePathCandidate } from "@waypoint/client-runtime/markdown-links";
import { mediaFileReference, mediaUrlReference } from "@waypoint/client-runtime/media-reference";
import { mediaKindFromPath, mediaMimeTypeFromExtension } from "@waypoint/shared/filePreview";
...
import { parseAssistantCitationHref } from "@waypoint/shared/assistantCitations";
...
const CHAT_MARKDOWN_SANITIZE_SCHEMA = {
  ...
  protocols: {
    ...
    href: [...(defaultSchema.protocols?.href ?? []), "file", "waypoint-citation"],
