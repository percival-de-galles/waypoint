...
import { CommandId, ProviderDriverKind, ThreadId } from "@waypoint/contracts";
...
import { useWaypointConnectAuthPrompt } from "../clerk/useWaypointConnectAuthPrompt";
    ...
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <WizardHeader
          ...
          identity={
            <div className="flex items-baseline gap-1.5" role="img" aria-label="Waypoint">
              <WaypointWordmark className="h-4 w-auto shrink-0" aria-hidden />
...
function ConnectAccountOption({
  ...
  const { openAuthPrompt } = useWaypointConnectAuthPrompt();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-1">Waypoint Connect</span>
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <CommandBlock command="npx waypoint connect" className="mt-3" />
          <p className="mt-3 text-xs text-muted-foreground">
            Keep Waypoint running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
      ...
      >
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <CommandBlock command="npx waypoint pair" className="mt-2" />
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start Waypoint first, or run <code className="font-mono">npx waypoint serve</code>. Add{" "}
