...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@waypoint/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "waypoint-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("waypoint-assistant-citation") === highlighted) {
      CSS.highlights.delete("waypoint-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("waypoint-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "waypoint-assistant-citation-pulse";
