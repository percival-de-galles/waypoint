...
import { renderCodexDirectivesForCopy } from "@waypoint/client-runtime/codex-markdown-directives";
...
import { type MessageId, type OrchestrationLatestTurn, type TurnId } from "@waypoint/contracts";
...
export type MessagesTimelineRow =
  ...
  | {
      ...
      summaryToolIcon?: "browser" | "device" | "waypoint" | "pull-request";
      hasFailure: boolean;
    }
  | {
      kind: "turn-fold";
