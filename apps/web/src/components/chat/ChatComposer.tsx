...
import { serializeComposerFileLink } from "@waypoint/shared/composerTrigger";
import { createModelSelection, normalizeModelSlug } from "@waypoint/shared/model";
import { USAGE_LIMITS_COMMAND } from "@waypoint/shared/usageLimits";
import {
  Fragment,
  memo,
  type ComponentProps,
...
} from "@waypoint/client-runtime/state/attachments";
import {
...
import type { UnifiedSettings } from "@waypoint/contracts/settings";
import {
  type ChatMessage,
  type SessionPhase,
  type Thread,
...
} from "@waypoint/client-runtime/providerSkills";
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const hasActiveTaskPresentation =
    activeTasksProgress !== null && activeTaskSteps !== null && activeTasksProgress.totalSteps > 0;
  const showTasksTab =
    !hasBannerItems &&
    !showComposerTopDrawer &&
    !isTasksDrawerOpen &&
    !isComposerCollapsedMobile &&
    hasActiveTaskPresentation;
  const activityPhase =
    props.threadSyncPhase ?? (!hasActiveTaskPresentation && phase === "running" ? "working" : null);
    ...
    >
      ...
      <ComposerBanner.Dock>
        <ComposerBanner.Column>
          ...
          />
          {!activityStackItem && (activityPhase || inlineTasksBadge) ? (
