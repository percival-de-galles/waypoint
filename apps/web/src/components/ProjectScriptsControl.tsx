...
const NO_FILE_SCRIPTS: ReadonlyArray<WaypointProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in waypoint.json, offered for import. */
  fileScripts?: ReadonlyArray<WaypointProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: WaypointProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From waypoint.json</MenuGroupLabel>
