...
} from "@waypoint/shared/filePreview";
...
import { mediaFileReference } from "@waypoint/client-runtime/media-reference";
...
const FILE_EXPLORER_STORAGE_KEY = "waypoint.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "waypoint.renderMarkdown";
const RENDER_BROWSER_FILE_STORAGE_KEY = "waypoint.renderBrowserFile";
