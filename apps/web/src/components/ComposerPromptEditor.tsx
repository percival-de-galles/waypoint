...
import { type ServerProviderSkill } from "@waypoint/contracts";
...
import { formatProviderSkillDisplayName } from "@waypoint/client-runtime/providerSkills";
...
export function ComposerPromptEditor({
  ...
  const initialConfig = useMemo<InitialConfigType>(
    () => ({
      namespace: "waypointtools-composer-editor",
      editable: true,
      nodes: [
        ComposerMentionNode,
        ComposerSkillNode,
