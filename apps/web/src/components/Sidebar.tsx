...
import { resolveThreadCurrentPullRequestLink } from "@waypoint/shared/threadPullRequests";
...
import {
  ...
  effectiveSnoozed,
  threadWokeAt,
} from "@waypoint/client-runtime/state/thread-settled";
import { resolveSettledThreadTimestamp } from "@waypoint/client-runtime/state/thread-sort";
import type { EnvironmentThreadShell } from "@waypoint/client-runtime/state/models";
import {
...
const SETTLED_SHELF_EXPANDED_KEY = "waypoint:sidebar:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "waypoint:sidebar:snoozed-expanded";
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  // Plain clicks open Waypoint; individual PR links also support opening the host in a new tab.
...
export default function Sidebar() {
  ...
  // Threads on non-primary environments (Waypoint Connect, hosted) resolve their
