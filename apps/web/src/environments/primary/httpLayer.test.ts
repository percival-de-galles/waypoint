import type { DesktopBridge } from "@waypoint/contracts";
...
describe.sequential("primary environment HTTP layer", () => {
  ...
  it.effect("uses cookie credentials for browser primary environments", () => {
    ...
    Object.defineProperty(globalThis, "window", {
      ...
      value: {
        location: {
          href: "http://127.0.0.1:4773/settings",
    ...
    return Effect.gen(function* () {
      yield* HttpClient.get("http://127.0.0.1:4773/api/auth/session");
  ...
  it.effect("uses bearer auth without cookies for desktop-managed primaries", () => {
    ...
    return Effect.gen(function* () {
      yield* HttpClient.get("http://127.0.0.1:4773/api/connect/link-state");
