...
import { VIDEO_FILE_EXTENSIONS } from "@waypoint/shared/video";
...
const PIERRE_ICON_SPRITE_ID = "waypoint-pierre-file-icon-sprite";

const WAYPOINT_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="waypoint-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="waypoint-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="waypoint-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="waypoint-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="waypoint-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="waypoint-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="waypoint-file-icon-pnpm" viewBox="0 0 32 32">
...
export const WAYPOINT_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: WAYPOINT_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "waypoint-file-icon-package-json",
    "tsconfig.json": "waypoint-file-icon-tsconfig",
    "agents.md": "waypoint-file-icon-agents",
    "claude.md": "waypoint-file-icon-claude",
    "readme.md": "waypoint-file-icon-readme",
    "pnpm-lock.yaml": "waypoint-file-icon-pnpm",
    "pnpm-workspace.yaml": "waypoint-file-icon-pnpm",
  },
  byFileExtension: Object.fromEntries(
    VIDEO_FILE_EXTENSIONS.map((extension) => [extension, "waypoint-file-icon-video"]),
  ),
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(WAYPOINT_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${WAYPOINT_FILE_ICON_SPRITE}`;
