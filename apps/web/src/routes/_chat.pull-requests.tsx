...
import { pullRequestHostOf, resolveEnvironmentMachineKind } from "@waypoint/contracts";
import type {
  EnvironmentId,
  ProjectId,
    ...
    <>
      {!capabilityKnown ? (
        ...
        <PullRequestsUnavailableState
          ...
          error="Update your Waypoint servers to browse pull requests."
        />
      ) : firstLoad ? (
        <PullRequestListGhost rows={7} />
      ...
      <div className="relative flex min-h-0 flex-1">
        ...
        {rightPanelPresent && renderedPullRequestSurface && panelEnvironmentId !== null ? (
          <RightPanelTabs
            ...
            widthStorageKey="waypoint:pull-request-panel-width"
