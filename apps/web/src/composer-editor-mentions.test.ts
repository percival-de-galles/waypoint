import { EnvironmentId, MessageId, ThreadId, type AssistantCitation } from "@waypoint/contracts";
...
describe("splitPromptIntoComposerSegments", () => {
  ...
  it("keeps malformed citation links as editable text", () => {
    const prompt = "[Assistant quote](waypoint-citation://v1/env/thread/message?text=missing+metadata)";
