...
import { remarkCodexDirectives } from "@waypoint/client-runtime/codex-markdown-directives";
...
describe("incremental Markdown parsing", () => {
  it("keeps the document prefix cached when list recovery parses contain fences", () => {
    ...
    expect(parsedSources.some((text) => text.startsWith("waypoint-markdown-inline-prefix:"))).toBe(true);
  });
