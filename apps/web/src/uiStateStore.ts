...
import type { PullRequestMergeMethod } from "@waypoint/contracts";
import { create } from "zustand";
import { normalizeProjectPathForComparison } from "./lib/projectPaths";

export const PERSISTED_STATE_KEY = "waypoint:ui-state:v1";
// Version 1 stored card visibility, not folder expansion.
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 2;
const LEGACY_PERSISTED_STATE_KEYS = [
  "waypoint:renderer-state:v8",
  "waypoint:renderer-state:v7",
  "waypoint:renderer-state:v6",
  "waypoint:renderer-state:v5",
  "waypoint:renderer-state:v4",
  "waypoint:renderer-state:v3",
