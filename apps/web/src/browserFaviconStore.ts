...
import type { DesktopPreviewFavicon, ScopedProjectRef, ScopedThreadRef } from "@waypoint/contracts";
...
const BROWSER_FAVICON_STORAGE_KEY = "waypoint:browser-favicons:v1";
