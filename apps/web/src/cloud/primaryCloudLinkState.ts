...
import type { EnvironmentCloudLinkStateResult } from "@waypoint/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read Waypoint Connect link state.";
  }
