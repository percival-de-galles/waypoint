...
import { RelayWebClientId } from "@waypoint/contracts/relay";
...
import { type RpcSession } from "@waypoint/client-runtime/rpc";
import { EnvironmentRegistry } from "@waypoint/client-runtime/connection";
import { ManagedRelay } from "@waypoint/client-runtime/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_WAYPOINT_RELAY_URL", "https://relay.example.test");
