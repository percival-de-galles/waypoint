export const RELEASES_URL = "https://waypoint.invalid/releases";
export const NIGHTLY_RELEASES_URL = `${RELEASES_URL}?q=nightly&expanded=true`;

const LATEST_API_URL = "https://waypoint.invalid/api/releases/latest";
...
const LIST_API_URL = "https://waypoint.invalid/api/releases?per_page=10";
...
function cacheKey(channel: ReleaseChannel) {
  return `waypoint-${channel}-release`;
}
