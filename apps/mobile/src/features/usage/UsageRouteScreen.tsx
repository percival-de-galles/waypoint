import { EnvironmentId, USAGE_CONTRACT_VERSION } from "@waypoint/contracts";
...
import {
  ...
  type DailyTotals,
  type MergedUsage,
} from "@waypoint/shared/usageMerge";
import {
  enumerateDays,
  enumerateHourStarts,
  formatCount,
  ...
  formatUsd,
  makeWindow,
} from "@waypoint/shared/usageFormat";
          ...
          >
            <Text
              className={cn(
                ...
                active ? "font-waypoint-medium text-foreground" : "text-foreground-muted",
              )}
            >
              {option.label}
            </Text>
  ...
  return (
    <View className="gap-4 rounded-[24px] border-continuous bg-card p-4">
      <View className="gap-0.5">
        ...
        <Text className="text-4xl font-waypoint-bold tabular-nums text-foreground">
...
function MetricCell(props: {
  ...
  return (
    <View className="w-1/2 gap-0.5 p-4">
      ...
      <Text className="text-xl font-waypoint-medium tabular-nums text-foreground">{props.value}</Text>
