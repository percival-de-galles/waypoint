...
import { WaypointKeyboardCommands } from "../../native/WaypointKeyboardCommands";
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <>
      <WaypointKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
        {children}
      </WaypointKeyboardCommands>
