    ...
    >
      <View className="max-w-[360px] items-center gap-3">
        <SymbolView
          ...
          type="hierarchical"
        />
        <Text className="text-center text-xl font-waypoint-bold">Select a thread</Text>
        ...
        {props.onStartNewTask ? (
          ...
          >
            <Text className="text-base font-waypoint-bold text-primary-foreground">New Task</Text>
          </Pressable>
        ) : null}
      </View>
    </View>
