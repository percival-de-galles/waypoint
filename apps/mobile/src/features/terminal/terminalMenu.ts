import { type KnownTerminalSession } from "@waypoint/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@waypoint/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@waypoint/shared/terminalLabels";
