...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@waypoint/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text className="font-waypoint-medium tabular-nums text-danger-foreground" numberOfLines={1}>
