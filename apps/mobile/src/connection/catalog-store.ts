...
import { ConnectionTransientError } from "@waypoint/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "waypoint.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "waypoint.connections";
