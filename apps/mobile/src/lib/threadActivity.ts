...
import { foldUserInputActivities } from "@waypoint/client-runtime/work-log/user-input";
import * as Schema from "effect/Schema";
import {
  requestKindFromRequestType,
  type PendingApproval,
} from "@waypoint/client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload, isToolLifecycleItemType } from "@waypoint/contracts";
import type {
...
import { extractToolActivityPresentation } from "@waypoint/client-runtime/work-log/tool-presentation";
import { commandProgramName } from "@waypoint/client-runtime/work-log/command-label";

import * as Arr from "effect/Array";
import * as Order from "effect/Order";

export type { PendingApproval, PendingUserInput } from "@waypoint/client-runtime/pending-requests";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@waypoint/contracts").ToolActivitySurface;
  toolIcon?: import("@waypoint/contracts").ToolActivityIcon;
  toolSource?: import("@waypoint/contracts").ToolActivitySource;
