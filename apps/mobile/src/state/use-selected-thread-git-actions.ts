...
import { EnvironmentProject, EnvironmentThreadShell } from "@waypoint/client-runtime/state/shell";
...
import type { GitRunStackedActionResult } from "@waypoint/contracts";
import {
