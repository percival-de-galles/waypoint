import { ProjectId, type ThreadPullRequestLink, type VcsStatusResult } from "@waypoint/contracts";
...
const pullRequest: NonNullable<VcsStatusResult["pr"]> = {
  ...
  url: "https://github.com/waypointtools/waypoint/pull/3774",
  baseRef: "main",
...
describe("resolveThreadPrSource compatibility", () => {
  const legacyRef = {
    ...
    repository: "waypointtools/waypoint",
    number: 1,
    url: "https://github.com/waypointtools/waypoint/pull/1",
  };
  const branchRef = { ...legacyRef, number: 2, url: "https://github.com/waypointtools/waypoint/pull/2" };
