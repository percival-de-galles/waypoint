...
const CONNECTIONS_KEY = "waypoint.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "waypoint.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "waypoint.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "waypoint.recent-thread-shortcuts";
...
>()("@waypoint/mobile/persistence/MobileStorage") {}
