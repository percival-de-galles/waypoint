...
import type { SidebarProjectGroupingMode } from "@waypoint/contracts";
...
const PREFERENCES_KEY = "waypoint.preferences";
const PREFERENCES_FALLBACK_KEY = "waypoint.preferences.fallback";
...
>()("@waypoint/mobile/persistence/MobilePreferencesStore") {}
