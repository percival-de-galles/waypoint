...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "waypoint-composer-paste"
...
public final class WaypointComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
