package expo.modules.waypointnativecontrols
...
class WaypointKeyboardCommandsModule : Module() {
  override fun definition() = ModuleDefinition {
    Name("WaypointKeyboardCommands")

    View(WaypointKeyboardCommandsView::class) {
      Prop("enabledCommands") { view: WaypointKeyboardCommandsView, commands: List<String> ->
...
class WaypointKeyboardCommandsView(
  context: Context,
