...
import WaypointMarkdownTextRunNativeComponent from "./WaypointMarkdownTextRunNativeComponent";
import WaypointMarkdownTextNativeComponent from "./WaypointMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <WaypointMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    ...
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <WaypointMarkdownTextNativeComponent
          {...textDefaults}
          {...containerProps}
          style={[flattenedStyle]}
        >
