...
import { makeKeyedCoalescingWorker } from "@waypoint/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@waypoint/shared/hostProcess";
import { getTerminalLabel } from "@waypoint/shared/terminalLabels";
...
>()("waypoint/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("WAYPOINT_")) {
    return true;
  }
...
// temporary mount (e.g. /tmp/.mount_Waypoint-XXXX/usr/bin, the bundled glib schemas,
