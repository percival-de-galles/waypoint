...
>()("waypoint/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Waypoint could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Waypoint still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
