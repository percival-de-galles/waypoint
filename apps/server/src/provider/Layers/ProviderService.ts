...
import { expandAssistantCitationsForProvider } from "@waypoint/shared/assistantCitations";
...
import { resolveProjectAgentBrowserAccess } from "@waypoint/shared/serverSettings";
    ...
    function* (threadId, rawInput) {
      ...
      return yield* Effect.gen(function* () {
        ...
        if (!instanceInfo.enabled) {
          return yield* toValidationError(
            "ProviderService.startSession",
            `Provider instance '${resolvedInstanceId}' is disabled in Waypoint settings.`,
          );
        }
