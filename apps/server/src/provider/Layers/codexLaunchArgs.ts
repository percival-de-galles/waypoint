import { tokenizeCliArgs } from "@waypoint/shared/cliArgs";

const WAYPOINT_CODEX_LAUNCH_ARGS_ENV = "WAYPOINT_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[WAYPOINT_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
