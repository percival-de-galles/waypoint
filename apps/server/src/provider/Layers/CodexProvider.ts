...
import { PREFERRED_DEFAULT_CODEX_MODELS, ServerSettingsError } from "@waypoint/contracts";

import { createModelCapabilities, readCustomModelEntries } from "@waypoint/shared/model";
    ...
    if (!codexSettings.enabled) {
      return buildServerProvider({
        ...
        probe: {
          ...
          status: "warning",
          auth: { status: "unknown" },
          message: "Codex is disabled in Waypoint settings.",
        },
      });
    }
