          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  WAYPOINT_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.waypoint-code.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.waypoint-code.bearer_token_env_var="WAYPOINT_MCP_BEARER_TOKEN"',
                ],
