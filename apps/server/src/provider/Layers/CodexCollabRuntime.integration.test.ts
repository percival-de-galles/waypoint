...
import { type ProviderApprovalDecision, type ProviderEvent, ThreadId } from "@waypoint/contracts";
  ...
  it.effect("looks up child model metadata once after activity registration", () =>
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCodexSessionRuntime({
        ...
        environment: { ...process.env, WAYPOINT_CODEX_COLLAB_SCRIPT: scriptPath },
      });
