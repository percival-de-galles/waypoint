...
import { normalizeModelSlug } from "@waypoint/shared/model";
...
export interface CodexSessionRuntimeOptions {
  ...
  /** Capabilities the session's `waypoint` MCP credential grants; drives the prompt blocks. */
...
/** Converts a Waypoint approval decision into the MCP elicitation wire response. */
...
function buildCodexCollaborationMode(input: {
  ...
  readonly browserToolsAvailable?: boolean | WaypointToolAvailability;
