...
describe("Antigravity process environment", () => {
  const profile: AntigravityProfile = {
    platform: "linux",
    geminiHome: "/waypoint/userdata/providers/antigravity/profile",
    acpDirectory: "/waypoint/userdata/providers/antigravity/profile/antigravity-acp",
    tokenPath: "/waypoint/userdata/providers/antigravity/profile/antigravity-acp/acp_token.json",
