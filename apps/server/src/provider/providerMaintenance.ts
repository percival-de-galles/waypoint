...
export const ProviderVersionCache = Context.Reference<Map<string, ProviderVersionCacheEntry>>(
  "@waypoint/server/providerMaintenance/ProviderVersionCache",
  {
 ...
 * owns that path; anything unproven stays manual-only so Waypoint never runs
