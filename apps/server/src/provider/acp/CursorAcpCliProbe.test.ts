 ...
 * Enable with: WAYPOINT_CURSOR_ACP_PROBE=1 bun run test --filter CursorAcpCliProbe
 */
...
describe.runIf(process.env.WAYPOINT_CURSOR_ACP_PROBE === "1")("Cursor ACP CLI probe", () => {
    ...
    Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "waypoint-probe", version: "0.0.0" },
