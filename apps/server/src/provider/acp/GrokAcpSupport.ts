import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@waypoint/contracts";
...
const WAYPOINT_CODE_OAUTH_REFERRER = "waypoint";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: WAYPOINT_CODE_OAUTH_REFERRER,
    },
  };
}
...
/**
 * Waypoint's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
