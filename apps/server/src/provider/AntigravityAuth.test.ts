...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@waypoint/contracts";
...
const owner = "waypoint-auth-session-owner";
const otherOwner = "waypoint-auth-session-other";
