...
import { type OrchestrationProject, ProjectId } from "@waypoint/contracts";
  ...
  it.effect("runs the inherited machine setup action in the checkout's worktree", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(open).toHaveBeenCalledWith({
        ...
        cwd: "/repo/worktrees/a",
        worktreePath: "/repo/worktrees/a",
        env: { WAYPOINT_PROJECT_ROOT: "/repo/project", WAYPOINT_WORKTREE_PATH: "/repo/worktrees/a" },
      });
    ...
    () => {
      ...
      return Effect.gen(function* () {
        ...
        expect(open).toHaveBeenCalledWith({
          ...
          worktreePath: "/repo/worktrees/a",
          env: {
            WAYPOINT_PROJECT_ROOT: "/repo/project",
            WAYPOINT_WORKTREE_PATH: "/repo/worktrees/a",
          },
        });
        expect(write).toHaveBeenCalledWith({
          threadId: "thread-1",
