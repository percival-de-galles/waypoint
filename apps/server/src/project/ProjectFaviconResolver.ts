...
>()("waypoint/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* WaypointProjectFileLoader.WaypointProjectFileLoader;
  ...
  const resolvePathUncached = Effect.fn("ProjectFaviconResolver.resolvePathUncached")(function* (
    ...
    // A waypoint.json iconPath takes precedence over the well-known locations.
