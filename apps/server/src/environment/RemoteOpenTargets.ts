 ...
 */
import { type RemoteOpenTarget } from "@waypoint/contracts";
import { HostProcessHostname } from "@waypoint/shared/hostProcess";
import * as NetService from "@waypoint/shared/Net";
import { readTailscaleStatus } from "@waypoint/tailscale";
...
>()("waypoint/environment/RemoteOpenTargets") {}
