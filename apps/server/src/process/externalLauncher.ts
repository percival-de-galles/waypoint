...
// per-command cache lookups in @waypoint/shared/shell.
//
...
// command-resolution cache in @waypoint/shared/shell, so a backward wall-clock
...
>()("waypoint/process/externalLauncher") {}
