...
import { isDevProxiedPath } from "@waypoint/shared/devProxy";
import { decodeOtlpTraceRecords } from "@waypoint/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["waypoint://app", "waypoint-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // WAYPOINT_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
