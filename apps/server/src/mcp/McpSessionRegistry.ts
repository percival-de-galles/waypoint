import { ProviderInstanceId, ThreadId } from "@waypoint/contracts";
...
>()("waypoint/mcp/McpSessionRegistry") {}
 ...
 * the only thing guarding the `waypoint` toolkits on a remote-reachable server.
 */
