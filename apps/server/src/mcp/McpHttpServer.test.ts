...
import { EnvironmentId, PreviewTabId, ProviderInstanceId, ThreadId } from "@waypoint/contracts";
...
const TestLayer = McpHttpServer.PreviewToolkitRegistrationLive.pipe(
  ...
  Layer.provideMerge(ServerConfig.layerTest(process.cwd(), { prefix: "waypoint-mcp-http-server-test-" })),
