    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          (
            ...
            'pingdotgg/waypoint',
            41,
            'https://github.com/pingdotgg/waypoint/pull/41',
            'created',
      ...
      yield* sql`
        ...
        VALUES (
          ...
          NULL,
          NULL,
          '{"projectId":"project-1","repository":"pingdotgg/waypoint","number":41,"url":"https://github.com/pingdotgg/waypoint/pull/41"}',
      ...
      const expectedPullRequests: ReadonlyArray<ThreadPullRequestLink> = [
        {
          ...
          repository: "pingdotgg/waypoint",
          number: 41,
          url: "https://github.com/pingdotgg/waypoint/pull/41",
          source: "created",
