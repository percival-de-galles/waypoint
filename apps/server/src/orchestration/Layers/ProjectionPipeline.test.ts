...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("waypoint-projection-pipeline-test-");
const encodeThreadLinkedPullRequest = Schema.encodeSync(
  Schema.fromJsonString(ThreadLinkedPullRequest),
);

it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-cursor-batch-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-import-shell-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-branch-pr-projection-")))(
    ...
    it.effect("persists branch pull request updates without changing manual links", () =>
      Effect.gen(function* () {
        ...
        const linkedPullRequest = {
          projectId,
          repository: "pingdotgg/waypoint",
          number: 42,
          url: "https://github.com/pingdotgg/waypoint/pull/42",
        };
        const branchPullRequest = {
          ...linkedPullRequest,
          number: 43,
          url: "https://github.com/pingdotgg/waypoint/pull/43",
        };
        const updates = [
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-base-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-pull-requests-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-attachments-safe-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-attachments-overwrite-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make("refs/waypoint/checkpoints/thread-revert-files/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.make("refs/waypoint/checkpoints/thread-revert-files/turn/2"),
          status: "ready",
          files: [],
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-attachments-revert-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-attachments-delete-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("waypoint-projection-attachments-replay-")))(
  "OrchestrationProjectionPipeline",
  (it) => {
      ...
      Effect.gen(function* () {
        ...
        yield* appendAndProject({
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-completed"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/waypoint/checkpoints/thread-conflict/turn/1"),
            status: "ready",
            files: [],
      ...
      const refreshEvents = [
        ...
        },
        {
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-shell-summary-1"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/waypoint/checkpoints/thread-shell-summary/1"),
            status: "ready",
            files: [],
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.make("refs/waypoint/checkpoints/thread-revert/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.make("refs/waypoint/checkpoints/thread-revert/turn/2"),
          status: "ready",
          files: [],
...
it.layer(makeProjectionPipelinePrefixedTestLayer("waypoint-pending-turn-terminal-test-"))(
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "waypoint-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "waypoint-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
