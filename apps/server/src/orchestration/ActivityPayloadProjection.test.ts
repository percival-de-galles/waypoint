...
import type { OrchestrationThreadActivity } from "@waypoint/contracts";
...
describe("projectActivityPayload", () => {
  ...
  it.each([
    ...
    {
      toolName: "mcp__waypoint__preview_navigate",
      result: { content: '{"url":"https://example.com/"}' },
    },
    { tool: "waypoint_preview_status", state: { output: '{"url":"https://example.com/"}' } },
    {
      toolName: "mcp__waypoint__preview_snapshot",
      result: {
        content: [
    ...
    {
      toolName: "mcp__waypoint__preview_click",
    ...
    ...[
      ...
      toolName: `mcp__waypoint__preview_${action}`,
      result: { content: '{"toolIcon":{"_tag":"website","pageUrl":"https://example.com/"}}' },
    })),
  ...
  it.each([
    ...
    {
      toolName: "mcp__waypoint__preview_evaluate",
      result: { content: '{"url":"https://example.com/"}' },
    },
    {
      toolName: "mcp__waypoint__preview_open",
      result: { isError: true, content: '{"url":"https://example.com/"}' },
    },
    { toolName: "mcp__waypoint__preview_open", result: { content: "malformed JSON" } },
    { toolName: "mcp__waypoint__preview_open", result: { content: '{"url":"about:blank"}' } },
