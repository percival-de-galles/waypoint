...
import type { SourceControlProviderKind } from "@waypoint/contracts";
import { detectSourceControlProviderFromRemoteUrl } from "@waypoint/shared/sourceControl";
...
>()("waypoint/sourceControl/SourceControlProviderRegistry") {}
