...
import { SourceControlProviderError, type ChangeRequest } from "@waypoint/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set WAYPOINT_BITBUCKET_EMAIL and WAYPOINT_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
