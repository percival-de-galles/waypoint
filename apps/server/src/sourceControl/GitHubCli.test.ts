...
import { VcsProcessExitError, VcsProcessSpawnError } from "@waypoint/contracts";
...
describe("GitHubCli.layer", () => {
  ...
  it.effect("keeps pull requests from gh versions without headRepository.nameWithOwner", () =>
    ...
    Effect.gen(function* () {
            ...
            JSON.stringify([
              {
                ...
                baseRefName: "main",
                headRefName: "waypoint/codex-turn-mapping",
                state: "OPEN",
                mergedAt: null,
      ...
      const result = yield* gh.listOpenPullRequests({
        cwd: "/repo",
        headSelector: "waypoint/codex-turn-mapping",
      });
