...
export function buildResourceTelemetryHistory(
  ...
  for (const snapshot of snapshots) {
    ...
    aggregateSamples.push({
      ...
      cpuPercent: merged.groups.allWaypoint.currentCpuPercent,
      rssBytes: merged.groups.allWaypoint.currentRssBytes,
      processCount: merged.groups.allWaypoint.processCount,
