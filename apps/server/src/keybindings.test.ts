import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@waypoint/contracts";
...
import { KeybindingsConfigError } from "@waypoint/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "waypoint-keybindings-test-",
        }),
      ),
    ),
  );
