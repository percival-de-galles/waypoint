import { normalizeThreadPullRequestKey } from "@waypoint/shared/threadPullRequests";
import {
  IsoDateTime,
  PositiveInt,
  ThreadId,
...
>()("waypoint/persistence/ProjectionThreadPullRequests/ProjectionThreadPullRequestRepository") {}
