import { readConnectAuthorizeRequest } from "@waypoint/shared/connectAuth";
...
const TEST_ENV = {
  WAYPOINT_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  WAYPOINT_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  WAYPOINT_HOSTED_APP_URL: "https://hosted.example.test",
};
