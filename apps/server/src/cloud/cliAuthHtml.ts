...
declare const __WAYPOINT_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __WAYPOINT_BUILD_CHANNEL__ === "undefined" ? "dev" : __WAYPOINT_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Waypoint (Dev)",
  nightly: "Waypoint (Nightly)",
  latest: "Waypoint",
...
<html lang="en">
  <head>
    ...
    <title>Waypoint Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Waypoint Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
