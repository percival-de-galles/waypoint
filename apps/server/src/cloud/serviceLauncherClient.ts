import type { ServerSelfUpdateOutcome } from "@waypoint/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different waypoint version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "waypoint/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("waypoint/cloud/serviceLauncherClient") {}
