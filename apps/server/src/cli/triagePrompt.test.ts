...
it("launch prompt stays a single argv-safe line naming the prompt file", () => {
  ...
  const launch = buildTriageLaunchPrompt(String.raw`C:\Users\a b\.waypoint\userdata\triage\x\prompt.md`);
  assert.notInclude(launch, "\n");
  assert.include(launch, String.raw`C:\Users\a b\.waypoint\userdata\triage\x\prompt.md`);
...
it("context file carries every path the playbook depends on", () => {
  const context = buildTriageContext({
    ...
    os: "linux x64 (7.0.0)",
    nodeVersion: "v24.0.0",
    launchedAs: "npx waypoint triage",
    server: "running (pid 42, http://127.0.0.1:4501)",
    paths: {
      stateDir: "/home/u/.waypoint/userdata",
      dbPath: "/home/u/.waypoint/userdata/state.sqlite",
      settingsPath: "/home/u/.waypoint/userdata/settings.json",
      logsDir: "/home/u/.waypoint/userdata/logs",
      serverLogPath: "/home/u/.waypoint/userdata/logs/server.log",
      serverTracePath: "/home/u/.waypoint/userdata/logs/server.trace.ndjson",
      providerEventLogPath: "/home/u/.waypoint/userdata/logs/provider/events.log",
      terminalLogsDir: "/home/u/.waypoint/userdata/logs/terminals",
      providerStatusCacheDir: "/home/u/.waypoint/caches",
      secretsDir: "/home/u/.waypoint/userdata/secrets",
      sourceCacheDir: "/home/u/.waypoint/source",
    },
  });
  assert.include(context, "/home/u/.waypoint/userdata/state.sqlite");
  assert.include(context, "/home/u/.waypoint/userdata/logs/server.trace.ndjson");
  assert.include(context, "/home/u/.waypoint/userdata/logs/provider/events.log");
  assert.include(context, "/home/u/.waypoint/userdata/secrets");
  assert.include(context, "/home/u/.waypoint/source");
  assert.include(context, "npx waypoint triage");
