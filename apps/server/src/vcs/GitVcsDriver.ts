  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `waypoint-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Waypoint",
        GIT_AUTHOR_EMAIL: "waypoint@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Waypoint",
        GIT_COMMITTER_EMAIL: "waypoint@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `waypoint checkpoint ref=${input.checkpointRef}`;
