...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@waypoint/contracts";
import { VcsUnsupportedOperationError } from "@waypoint/contracts";
...
>()("waypoint/vcs/VcsDriverRegistry") {}
