...
import { type ClaudeSettings, type ModelSelection } from "@waypoint/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@waypoint/shared/git";
    ...
    const runClaudeCommand = Effect.fn("runClaudeJson.runClaudeCommand")(function* () {
      ...
      const workingDirectory =
        operation === "generateThreadTitle"
          ? yield* fileSystem
              .makeTempDirectoryScoped({ prefix: "waypoint-claude-title-" })
              .pipe(
                Effect.mapError((cause) =>
