 ...
 * environment session with read scope (operate scope for input and tuning). Reusing the Waypoint
 * origin is also what makes remote connections work unchanged — Tailscale and
 * Waypoint Connect already carry `/api/*` and WebSocket upgrades for the app itself.
 *
