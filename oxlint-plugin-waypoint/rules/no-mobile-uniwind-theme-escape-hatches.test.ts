...
const guardedMobileFile = createOxlintRuleHarness("waypoint/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/settings/NewThemeSurface.tsx",
});
const reviewedInteropFile = createOxlintRuleHarness(
  "waypoint/no-mobile-uniwind-theme-escape-hatches",
  {
...
describe("waypoint/no-mobile-uniwind-theme-escape-hatches", () => {
