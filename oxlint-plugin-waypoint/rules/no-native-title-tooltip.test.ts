...
const rule = createOxlintRuleHarness("waypoint/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("waypoint/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Waypoint";`);
