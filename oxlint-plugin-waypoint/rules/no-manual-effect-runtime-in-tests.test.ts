...
const rule = createOxlintRuleHarness("waypoint/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("waypoint/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("waypoint/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("waypoint/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("waypoint/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
