...
This directory maintains the [`waypoint-bin`](https://aur.archlinux.org/packages/waypoint-bin) and
[`waypoint-nightly-bin`](https://aur.archlinux.org/packages/waypoint-nightly-bin) packages. Both
